...
aList = []
errList = []
for a in np.linspace(start=0.408, stop=0.903, num=45):
...
aList = []
errList = []
for a in np.linspace(start=0.413, stop=0.910, num=45):
    err = errMeanVar(width=a)
    print("n=%d,a=%.2f, MeanErr&VarErr=%s" %
          (sampleSize, a, err))
    aList.append(a)
...
aList = []
errList = []
for a in np.linspace(start=0.409, stop=0.905, num=45):
  err = errMeanVar(width=a)
  print("n=%d,a=%.2f, MeanErr&VarErr=%s" %
        (sampleSize, a, err))
  aList.append(a)
...
aList = []
errList = []
for a in np.linspace(start=0.411, stop=0.915, num=45):
  err = errMeanVar(width=a)
  print("n=%d,a=%.2f, MeanErr&VarErr=%s" %
        (sampleSize, a, err))
  aList.append(a)
...
aList = []
errList = []
for a in np.linspace(start=0.410, stop=0.906, num=45):
  err = errMeanVar(width=a)
  print("n=%d,a=%.2f, MeanErr&VarErr=%s" %
        (sampleSize, a, err))
  aList.append(a)
...
mp.pyplot.savefig(filename="error_gaussian.png", dpi=1200)
